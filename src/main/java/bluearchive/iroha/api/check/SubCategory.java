...
//            item = Mika.SERVER_VERSION.isNewerThan(ServerVersion.V_1_12_2) ? Material.CHEST_MINECART : Material.getMaterial("STORAGE_MINECART");
//        } else if (item == Material.EMERALD) {
//            item = Mika.SERVER_VERSION.isNewerThan(ServerVersion.V_1_12_2) ? Material.BIRCH_STAIRS : Material.getMaterial("BIRCH_WOOD_STAIRS");
//        } else if (item == Material.GOLD_INGOT) {
//            item = Mika.VER_VERSION.isOlderThanOrEquals(ServerVersion.V_1_7_10) ? Material.GLASS_BOTTLE : Material.getMaterial("RABBIT_FOOT");
//        }
